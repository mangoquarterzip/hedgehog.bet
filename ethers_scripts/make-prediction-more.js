...
// total of 4 things to change 
document.addEventListener('DOMContentLoaded', () => {
    const predictionMoreButton = document.getElementById('make-prediction-more');
    // change the function name here                    change the id finder here
    predictionMoreButton.addEventListener('click', startBet);
});
async function startBet() {
    ...
    try {
        const result = await contract.startBet("1");
        //change the function name here   change arguaments
        console.log(result);
    } catch (error) {
