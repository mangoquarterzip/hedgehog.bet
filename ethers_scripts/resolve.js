...
document.addEventListener('DOMContentLoaded', () => {
    const resolveButton = document.getElementById('resolve-new');
...
async function resolve() {
    ...
    console.log(LOADED_CONTRACT);
    const contractAddress = LOADED_CONTRACT; // Contract address

    const contract = new ethers.Contract(contractAddress, contractABI, provider.getSigner());

    try {
        const result = await contract.resolveBet();
