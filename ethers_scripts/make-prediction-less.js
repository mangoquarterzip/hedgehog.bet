...
document.addEventListener('DOMContentLoaded', () => {
    const predictionLessButton = document.getElementById('make-prediction-less');
    // change the function name here                    change the id finder here
    predictionLessButton.addEventListener('click', startBet);
});
async function startBet() {
    ...
    try {
        const result = await contract.startBet("0");
